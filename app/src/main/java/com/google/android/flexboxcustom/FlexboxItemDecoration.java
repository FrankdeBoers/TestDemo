 ...
 * view holders within the {@link com.google.android.flexboxcustom.FlexboxLayoutManager}.
 *
...
public class FlexboxItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(
        ...
        com.google.android.flexboxcustom.FlexboxLayoutManager layoutManager = (com.google.android.flexboxcustom.FlexboxLayoutManager) parent.getLayoutManager();
        List<com.google.android.flexboxcustom.FlexLine> flexLines = layoutManager.getFlexLines();
    ...
    private void setOffsetAlongCrossAxis(Rect outRect, int position,
                                         com.google.android.flexboxcustom.FlexboxLayoutManager layoutManager, List<com.google.android.flexboxcustom.FlexLine> flexLines) {
        if (flexLines.size() == 0) {
            return;
        }
    ...
    private void setOffsetAlongMainAxis(Rect outRect, int position,
                                        com.google.android.flexboxcustom.FlexboxLayoutManager layoutManager, List<com.google.android.flexboxcustom.FlexLine> flexLines, int flexDirection) {
        ...
        if (layoutManager.isMainAxisDirectionHorizontal()) {
            ...
            if (flexDirection == com.google.android.flexboxcustom.FlexDirection.COLUMN_REVERSE) {
     ...
     */
    private boolean isFirstItemInLine(int position, List<com.google.android.flexboxcustom.FlexLine> flexLines,
