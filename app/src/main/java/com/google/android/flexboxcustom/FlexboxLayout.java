...
public class FlexboxLayout extends ViewGroup implements FlexContainer {
    ...
    /**
     * The current value of the {@link com.google.android.flexboxcustom.FlexWrap}, the default value is {@link com.google.android.flexboxcustom.FlexWrap#NOWRAP}.
     *
     * @see com.google.android.flexboxcustom.FlexWrap
     */
     ...
     * {@link com.google.android.flexboxcustom.AlignItems#FLEX_START}.
     *
     * @see com.google.android.flexboxcustom.AlignItems
     */
    private int mAlignItems;

    /**
     * The current value of the {@link com.google.android.flexboxcustom.AlignContent}, the default value is
     * {@link com.google.android.flexboxcustom.AlignContent#FLEX_START}.
     *
     * @see com.google.android.flexboxcustom.AlignContent
     */
    ...
    private com.google.android.flexboxcustom.FlexboxHelper mFlexboxHelper = new com.google.android.flexboxcustom.FlexboxHelper(this);
    ...
    public FlexboxLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, com.google.android.flexbox.R.styleable.FlexboxLayout, defStyleAttr, 0);
        mFlexDirection = a
                .getInt(com.google.android.flexbox.R.styleable.FlexboxLayout_flexDirection, FlexDirection.ROW);
        mFlexWrap = a.getInt(com.google.android.flexbox.R.styleable.FlexboxLayout_flexWrap, com.google.android.flexboxcustom.FlexWrap.NOWRAP);
        mJustifyContent = a
                .getInt(com.google.android.flexbox.R.styleable.FlexboxLayout_justifyContent, JustifyContent.FLEX_START);
        mAlignItems = a.getInt(com.google.android.flexbox.R.styleable.FlexboxLayout_alignItems, com.google.android.flexboxcustom.AlignItems.FLEX_START);
        mAlignContent = a.getInt(com.google.android.flexbox.R.styleable.FlexboxLayout_alignContent, com.google.android.flexboxcustom.AlignContent.FLEX_START);
        mMaxLine = a.getInt(com.google.android.flexbox.R.styleable.FlexboxLayout_maxLine, NOT_SET);
        Drawable drawable = a.getDrawable(com.google.android.flexbox.R.styleable.FlexboxLayout_dividerDrawable);
        if (drawable != null) {
            setDividerDrawableHorizontal(drawable);
            setDividerDrawableVertical(drawable);
        }
        Drawable drawableHorizontal = a
                .getDrawable(com.google.android.flexbox.R.styleable.FlexboxLayout_dividerDrawableHorizontal);
        if (drawableHorizontal != null) {
            setDividerDrawableHorizontal(drawableHorizontal);
        }
        Drawable drawableVertical = a
                .getDrawable(com.google.android.flexbox.R.styleable.FlexboxLayout_dividerDrawableVertical);
        if (drawableVertical != null) {
            setDividerDrawableVertical(drawableVertical);
        }
        int dividerMode = a.getInt(com.google.android.flexbox.R.styleable.FlexboxLayout_showDivider, SHOW_DIVIDER_NONE);
        ...
        int dividerModeVertical = a
                .getInt(com.google.android.flexbox.R.styleable.FlexboxLayout_showDividerVertical, SHOW_DIVIDER_NONE);
        if (dividerModeVertical != SHOW_DIVIDER_NONE) {
            mShowDividerVertical = dividerModeVertical;
        }
        int dividerModeHorizontal = a
                .getInt(com.google.android.flexbox.R.styleable.FlexboxLayout_showDividerHorizontal, SHOW_DIVIDER_NONE);
    ...
    private void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mAlignItems == com.google.android.flexboxcustom.AlignItems.BASELINE) {
            for (com.google.android.flexboxcustom.FlexLine flexLine : mFlexLines) {
    ...
    public static class LayoutParams extends MarginLayoutParams implements FlexItem {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            ...
            TypedArray a = context
                    .obtainStyledAttributes(attrs, com.google.android.flexbox.R.styleable.FlexboxLayout_Layout);
            mOrder = a.getInt(com.google.android.flexbox.R.styleable.FlexboxLayout_Layout_layout_order, ORDER_DEFAULT);
            mFlexGrow = a
                    .getFloat(com.google.android.flexbox.R.styleable.FlexboxLayout_Layout_layout_flexGrow, FLEX_GROW_DEFAULT);
            mFlexShrink = a.getFloat(com.google.android.flexbox.R.styleable.FlexboxLayout_Layout_layout_flexShrink,
                    FLEX_SHRINK_DEFAULT);
            mAlignSelf = a
                    .getInt(com.google.android.flexbox.R.styleable.FlexboxLayout_Layout_layout_alignSelf, com.google.android.flexboxcustom.AlignSelf.AUTO);
            mFlexBasisPercent = a
                    .getFraction(com.google.android.flexbox.R.styleable.FlexboxLayout_Layout_layout_flexBasisPercent, 1, 1,
                            FLEX_BASIS_PERCENT_DEFAULT);
            mMinWidth = a
                    .getDimensionPixelSize(com.google.android.flexbox.R.styleable.FlexboxLayout_Layout_layout_minWidth, NOT_SET);
            mMinHeight = a
                    .getDimensionPixelSize(com.google.android.flexbox.R.styleable.FlexboxLayout_Layout_layout_minHeight, NOT_SET);
            mMaxWidth = a.getDimensionPixelSize(com.google.android.flexbox.R.styleable.FlexboxLayout_Layout_layout_maxWidth,
                    MAX_SIZE);
            mMaxHeight = a.getDimensionPixelSize(com.google.android.flexbox.R.styleable.FlexboxLayout_Layout_layout_maxHeight,
                    MAX_SIZE);
            mWrapBefore = a.getBoolean(com.google.android.flexbox.R.styleable.FlexboxLayout_Layout_layout_wrapBefore, false);
            a.recycle();
        }
