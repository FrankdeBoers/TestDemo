...
class FlexboxHelper {
    ...
    void calculateHorizontalFlexLines(FlexLinesResult result, int widthMeasureSpec,
            ...
            @Nullable List<com.google.android.flexboxcustom.FlexLine> existingLines) {
    ...
    void calculateHorizontalFlexLinesToIndex(FlexLinesResult result, int widthMeasureSpec,
            int heightMeasureSpec, int needsCalcAmount, int toIndex, List<com.google.android.flexboxcustom.FlexLine> existingLines) {
        calculateFlexLines(result, widthMeasureSpec, heightMeasureSpec, needsCalcAmount,
    ...
    void calculateFlexLines(FlexLinesResult result, int mainMeasureSpec,
        ...
        List<com.google.android.flexboxcustom.FlexLine> flexLines;
        ...
        com.google.android.flexboxcustom.FlexLine flexLine = new com.google.android.flexboxcustom.FlexLine();
        ...
        for (int i = fromIndex; i < childCount; i++) {
            ...
            if (flexItem.getAlignSelf() == com.google.android.flexboxcustom.AlignItems.STRETCH) {
            ...
            if (isWrapRequired(child, mainMode, mainSize, flexLine.mMainSize,
                ...
                flexLine = new com.google.android.flexboxcustom.FlexLine();
            ...
            if (isMainHorizontal) {
                if (mFlexContainer.getFlexWrap() != com.google.android.flexboxcustom.FlexWrap.WRAP_REVERSE) {
    ...
    private boolean isWrapRequired(View view, int mode, int maxSize, int currentLength,
        ...
        if (mFlexContainer.getFlexWrap() == com.google.android.flexboxcustom.FlexWrap.NOWRAP) {
            return false;
        }
    ...
    private boolean isLastFlexItem(int childIndex, int childCount,
            com.google.android.flexboxcustom.FlexLine flexLine) {
        return childIndex == childCount - 1 && flexLine.getItemCountNotGone() != 0;
    }

    private void addFlexLine(List<com.google.android.flexboxcustom.FlexLine> flexLines, com.google.android.flexboxcustom.FlexLine flexLine, int viewIndex,
    ...
    void determineMainSize(int widthMeasureSpec, int heightMeasureSpec, int fromIndex) {
        ...
        List<com.google.android.flexboxcustom.FlexLine> flexLines = mFlexContainer.getFlexLinesInternal();
        for (int i = flexLineIndex, size = flexLines.size(); i < size; i++) {
            com.google.android.flexboxcustom.FlexLine flexLine = flexLines.get(i);
     ...
     */
    private void expandFlexItems(int widthMeasureSpec, int heightMeasureSpec, com.google.android.flexboxcustom.FlexLine flexLine,
     ...
     */
    private void shrinkFlexItems(int widthMeasureSpec, int heightMeasureSpec, com.google.android.flexboxcustom.FlexLine flexLine,
            int maxMainSize, int paddingAlongMainAxis, boolean calledRecursively) {
        ...
        if (mode == View.MeasureSpec.EXACTLY) {
            ...
            if (flexLines.size() == 1) {
                ...
                switch (mFlexContainer.getAlignContent()) {
                    case com.google.android.flexboxcustom.AlignContent.STRETCH: {
                    ...
                    case com.google.android.flexboxcustom.AlignContent.SPACE_AROUND: {
                        if (totalCrossSize >= size) {
                        ...
                        List<com.google.android.flexboxcustom.FlexLine> newFlexLines = new ArrayList<>();
                        com.google.android.flexboxcustom.FlexLine dummySpaceFlexLine = new com.google.android.flexboxcustom.FlexLine();
                        dummySpaceFlexLine.mCrossSize = spaceTopAndBottom;
                        for (com.google.android.flexboxcustom.FlexLine flexLine : flexLines) {
                    ...
                    case com.google.android.flexboxcustom.AlignContent.SPACE_BETWEEN: {
                        if (totalCrossSize >= size) {
                            break;
                        }
                    ...
                    case com.google.android.flexboxcustom.AlignContent.CENTER: {
                        mFlexContainer.setFlexLines(
                                constructFlexLinesForAlignContentCenter(flexLines, size,
                                        totalCrossSize));
                        break;
                    }
                    case com.google.android.flexboxcustom.AlignContent.FLEX_END: {
    ...
    private List<com.google.android.flexboxcustom.FlexLine> constructFlexLinesForAlignContentCenter(List<com.google.android.flexboxcustom.FlexLine> flexLines,
     ...
     * com.google.android.flexboxcustom.AlignItems#STRETCH} or {@link FlexItem#getAlignSelf()} is set as
    ...
    void stretchViews(int fromIndex) {
        ...
        int flexDirection = mFlexContainer.getFlexDirection();
        if (mFlexContainer.getAlignItems() == com.google.android.flexboxcustom.AlignItems.STRETCH) {
            int flexLineIndex = 0;
            if (mIndexToFlexLine != null) {
                flexLineIndex = mIndexToFlexLine[fromIndex];
            }
            ...
            for (int i = flexLineIndex, size = flexLines.size(); i < size; i++) {
                ...
                for (int j = 0, itemCount = flexLine.mItemCount; j < itemCount; j++) {
                    ...
                    FlexItem flexItem = (FlexItem) view.getLayoutParams();
                    if (flexItem.getAlignSelf() != com.google.android.flexboxcustom.AlignSelf.AUTO &&
                            flexItem.getAlignSelf() != com.google.android.flexboxcustom.AlignItems.STRETCH) {
                        continue;
                    }
                    switch (flexDirection) {
                        case FlexDirection.ROW: // Intentional fall through
            ...
            for (com.google.android.flexboxcustom.FlexLine flexLine : mFlexContainer.getFlexLinesInternal()) {
     ...
     * @param flexLine the {@link com.google.android.flexboxcustom.FlexLine} where the View belongs to
     ...
     * @see FlexItem#getAlignSelf()
     */
    void layoutSingleChildHorizontal(View view, com.google.android.flexboxcustom.FlexLine flexLine, int left, int top, int right,
                                     int bottom) {
        FlexItem flexItem = (FlexItem) view.getLayoutParams();
        ...
        switch (alignItems) {
            case com.google.android.flexboxcustom.AlignItems.FLEX_START: // Intentional fall through
            case com.google.android.flexboxcustom.AlignItems.STRETCH:
                if (mFlexContainer.getFlexWrap() != com.google.android.flexboxcustom.FlexWrap.WRAP_REVERSE) {
                ...
                break;
            case com.google.android.flexboxcustom.AlignItems.BASELINE:
                if (mFlexContainer.getFlexWrap() != com.google.android.flexboxcustom.FlexWrap.WRAP_REVERSE) {
                ...
                break;
            case com.google.android.flexboxcustom.AlignItems.FLEX_END:
                if (mFlexContainer.getFlexWrap() != com.google.android.flexboxcustom.FlexWrap.WRAP_REVERSE) {
                    view.layout(left,
                ...
                break;
            case com.google.android.flexboxcustom.AlignItems.CENTER:
     ...
     * @see FlexItem#getAlignSelf()
     */
    void layoutSingleChildVertical(View view, com.google.android.flexboxcustom.FlexLine flexLine, boolean isRtl,
        ...
        switch (alignItems) {
            case com.google.android.flexboxcustom.AlignItems.FLEX_START: // Intentional fall through
            case com.google.android.flexboxcustom.AlignItems.STRETCH: // Intentional fall through
            case com.google.android.flexboxcustom.AlignItems.BASELINE:
                if (!isRtl) {
     ...
     */
    void clearFlexLines(List<com.google.android.flexboxcustom.FlexLine> flexLines, int fromFlexItem) {
